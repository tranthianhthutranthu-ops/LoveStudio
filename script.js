...
const firebaseConfig = {
    apiKey: "AIzaSyBtG2yIsg7wfvxdFXCC4pahfYw4MAc_5C8",
    authDomain: "lovestudio-f0197.firebaseapp.com",
    databaseURL: "https://lovestudio-f0197-default-rtdb.firebaseio.com",
    projectId: "lovestudio-f0197",
    storageBucket: "lovestudio-f0197.firebasestorage.app",
    messagingSenderId: "984505125728",
    appId: "1:984505125728:web:183f64c67761854ac2c05",
    measurementId: "G-M8V6Y4G9QZ"
};
...
if (!isLovePage) {
    ...
    if (btn) {
        ...
        btn.addEventListener("click", () => {
            ...
            // ===============================
// LƯU LOVE PAGE LÊN FIREBASE
// ===============================

const loveRef = database.ref("lovePages").push();

const loveId = loveRef.key;
...
.then(() => {
    ...
    // Lưu link trên máy
    localStorage.setItem("LovePageLink", loveLink);

    // Chuyển sang Love Page
    window.location.href = "love.html?id=" + loveId;                                                                                                                                                                                                                                                                                                                                                                        
...
.catch((error) => {
    ...
    alert(
        "Không thể tạo Love Page. Hãy kiểm tra kết nối Firebase nhé ❤️"
    );
...
function showLinkBox(url) {
    ...
    if (navigator.clipboard) {
        navigator.clipboard.writeText(url).then(function () {
            ...
            prompt("❤️ Hãy sao chép link Love Page này:", url);
        });
    } else {
        prompt("❤️ Hãy sao chép link Love Page này:", url);
    }
